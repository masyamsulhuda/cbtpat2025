        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div>
                        <h3 class="card-title mb-0 font-weight-bold">Import Data Siswa</h3>
                        <div class="small text-muted"><b class="badge badge-success"><?php echo $lembaga['lembaga_profile'] ?></b></div>
                    </div>
                    <div class="btn-toolbar">
                        <a href="<?php echo base_url(); ?>upload/format_import_siswa.xlsx"> <button class="btn btn-xs btn-default m-1 fw-bold"><i class="fa fa-cloud-download" aria-hidden="true"></i><span class="d-none d-md-block">Download</span></button></a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <span class="fw-bold">Halaman Import Data Siswa</span> <br> <small>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 text-left">
                                <div class="form-group form-group-default bg-dop">
                                    <label class="text-secondary fw-bold"><i class="fa fa-cloud-download" aria-hidden="true"></i> UPLOAD FILE TEMPLATE SISWA</label>
                                    <br>
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-sm-12 text-left">
                            ...
                            <a href="<?php echo base_url(); ?>adm/m_siswa" class="btn btn-default fw-bold"><i class="fa fa-minus-circle"></i> Kembali</a>
                        </div>
                    </div>
                </div>
                </form>
