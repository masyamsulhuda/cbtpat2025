...
//       var columnKelas = this.api().column(3);
//       columnKelas.column(3).visible(false);

//       var selectKelas = $('<select class="filter form-control form-control-sm"><option value="" selected>Kelas/Tingkat</option></select>')
//         .appendTo('#selectTingkatNaik')
//         .on('change', function() {
//           var val = $(this).val();
